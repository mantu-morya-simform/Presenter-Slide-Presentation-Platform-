...
export const startPresentationButtonElement =document.querySelector<HTMLButtonElement>('.start-presentation-btn');
export const fullScreenBtn=document.querySelector<HTMLButtonElement>('.fullscreen');